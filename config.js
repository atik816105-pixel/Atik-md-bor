...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+8801616084013', // Mettez votre numéro ici
    BOT_NAME: "ATIK MD BOT",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ atik-ᴍᴅ',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/DcyNsGGLF4NKfz7a76FBSd?s=cl&p=a&ilr=4',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://files.catbox.moe/1d7gek.png',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbCurlHBKfi7r2AQNv12',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '7214172448:AAHGqSgaw-zGVPZWvl8msDOVDhln-9kExas',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '+8801956501630'
